...
import { normalizeResearchVerdict } from "./normalizeResearchVerdict.js";
...
const readTextFile = async (filename) => fs.readFile(filename, "utf8");
...
export const runNbaPropResearchSkill = async (input, options = {}) => {
  validateInput(input);
  ...
  const rawResult = parseJsonResponse(response);
